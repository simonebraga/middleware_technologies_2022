...
public class PoiMap {
    ...
    public static void initPoiMap(String mapFile) {
        ...
        try {
            ...
            System.err.println("ERROR: Fatal problem with map file mapping!");
    ...
    private static Double computeDistance(Double x, Double y, Poi poi) {
    ...
    public static String computeNearestPoi(Double x, Double y) {
